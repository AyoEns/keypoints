...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------#
    test_interval   = 100
    fps_image_path  = "img/Image0191_12-23-03.jpg"
    #-------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        while True:
            ...
            try:
                ...
                zero_map = np.zeros(image1.shape[0:2], dtype=np.uint8)
                ...
                for i in range(len(result)):
                    ...
                    x = int(x)
                    y = int(y)
                    cv2.circle(zero_map, (y,x),radius=1, color=(255,255,255), thickness=-1)
                cv2.imshow("1", zero_map)
                cv2.imwrite("./1.jpg", zero_map, [cv2.IMWRITE_JPEG_QUALITY, 100])
                cv2.waitKey()
